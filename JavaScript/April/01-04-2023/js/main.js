...
// showtask();
// let addtaskinput = document.getElementById("addtaskinput"); //used for grasp value which enteded by user
// let addtaskbtn = document.getElementById("addtaskbtn");

// addtaskbtn.addEventListener("click", function () { //This funbction we used for Stroe The data in locl STtorage
//     addtaskinputval = addtaskinput.value;
//     if (addtaskinputval.trim() != 0) // remove extra spaces remove(trim)
//     {
//         let webtask = localStorage.getItem("localtask");
...
//         //below line is used for after enter value removce input box
//         localStorage.setItem("localtask", JSON.stringify(taskObj));
//         addtaskinput.value = '';
//     }
//     showtask();
...
// function showtask() {               // this function we can used for show the data  Which was saved by usrr usinhg input box
//     let webtask = localStorage.getItem("localtask");
//     if (webtask == null) {
//         taskObj = [];
//     }
